...
/**
 * Sends a verification email to the user containing a verification link.
 * Creates a verification token, stores it in the database, and sends the email.
 * Throws an error if any operation fails.
 *
 * @param user an object representing the user to whom the verification email will be sent
 ...
 * Creates a password reset token, stores it in the database, and sends the email.
 * Throws an error if any operation fails.
 *
 * @param user an object representing the user to whom the password reset link will be sent
 * @param res the response object used to send responses back to the client
 * @return Promise<void> a Promise that resolves when the email is sent successfully
 */
